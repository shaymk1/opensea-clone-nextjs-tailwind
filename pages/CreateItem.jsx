...
export default function CreateItem() {
	...
	const [formInput, updateFormInput] = { price: "", name: "", description: "" };
	...
	async function onChange(e) {
		...
		try {
			...
			const added = await client.add(file, {
				//you can make a nice modal for this
		...
		return (
			<div className="flex justify-center">
				<div className="w-1/2 flex flex-col pb-12">
					...
					<button
						onClick={createItem}
						className="font-bold mt-4 bg-[#cb97ef] hover:bg-[#ac59e7]  text-white rounded p-4 shadow-lg">
						Create NFT
					</button>
				</div>
			</div>
